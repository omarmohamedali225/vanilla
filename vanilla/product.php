...
<section class="container product pt-5 pb-5">
  <div class="row">
    ...
    <div class="col-lg-7 col-12">
      <img src="./assets/images/<?php print_r($fetch['img'])?>" class="img-fluid w-100 imgsec">
    </div>
    <div class="col-lg-5 col-12">
      <div class="datails">
        <h1 class="mt-3 mt-lg-0"><?php print_r($fetch['name'])?></h1>
        <p><?php print_r($fetch['title'])?></p>
        <p class="fw-bold">تكفي كام فرد : <span class="pr">حتي <?php $fetch['num']<3 ? print_r($fetch['num'] . ' فرد') : print_r($fetch['num'] . ' افراد')?></span></p>
        <div class="number">
          <button class="plus"><i class="fa-solid fa-plus"></i></button>
          <input type="number" size="4" inputmode="numeric" min="1" max="50" value="1">
          <button class="minus"><i class="fa-solid fa-minus"></i></button>
        </div>
        <a href="addcart/<?php print_r($fetch['id'])?>" data-product="<?php print_r($fetch['id'])?>">اضف للسلة</a>
        <h5>التوصيل في نفس اليوم أو في التاريخ اللي تحبه</h5>
      </div>
    </div>
  </div>
</section>
...
<section class="sec text-center pt-5 pb-5">
  <div class="container">
    <div class="title mt-5 mb-5">
      <h1 class="fw-bold">يتم شراءه عادة مع</h1>
      <p class="text-black-50">منتجات ذات صلة</p>
    </div>
    <div class="row">
      <?php
      ...
      <div class="col-lg-3 col-md-4 col-6 col">
        <div class="box">
          <div class="img"><img src="./assets/images/<?php print_r($fetch['img'])?>" class="img-fluid" alt="img"></div>
          <div class="datails">
...
<section class="sec text-center pt-5 pb-5">
  <div class="container">
    <div class="title mt-5 mb-5">
      <h1 class="fw-bold">تسوق اكتر</h1>
      <p class="text-black-50">منتجات هتعجبك</p>
    </div>
    <div class="row">
      <?php
      $query = mysqli_query($con,"SELECT * FROM products order by Rand() LIMIT 4");
